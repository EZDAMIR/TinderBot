...
public class TinderBoltApp extends MultiSessionTelegramBot {
    ...
    public static final String TELEGRAM_BOT_TOKEN = Config.get("TELEGRAM_BOT_TOKEN");
    ; //TODO: добавь токен бота в config.properties
    public static final String OPEN_AI_TOKEN = Config.get("OPEN_AI_TOKEN");
    ; //TODO: добавь токен ChatGPT в config.properties
